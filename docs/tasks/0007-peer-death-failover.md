...
- [ ] Eviction telemetry on the *original* owner is not expected (it's dead); telemetry on the new owner fires `[:loam, :anchor, :registered]` and `[:loam, :anchor, :child_started]`.
